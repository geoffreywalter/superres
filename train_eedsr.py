...
from models import SRResNet, create_generator, create_discriminator, create_gan, EDSR, EEDSR
...
model = Model(inputs=input1, outputs=EEDSR(input1, config.filters, config.nBlocks))
